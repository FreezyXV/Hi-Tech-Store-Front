...
//       return;
//     }
//     dispatch(addItemToCart({ variant: selectedVariant, quantity: 1 }));
...
const ProductPage = () => {
  ...
  // --------------------------------------------------
  // When attributes change, filter the matched variants
  // --------------------------------------------------
  useEffect(() => {
    const filterVariants = () => {
      if (!variants.length) return;
  ...
  return (
    <div className="body">
      <div className="product-page-wrapper">
        <div className="product-page">
          <div className="product-container">
            {/* Left Section: main product details */}
            <div className="product-main">
              <div className="product-image">
                <div className="image-container">
                  <img
            ...
            {/* Right Section: variant selection + price */}
            <div className="variant-selector-main">
              <h2>{model ? model.name : "Unknown Model"}</h2>
              <p className="product-price">Price: {price} €</p>
              <p className="product-stock">Stock: {stock}</p>
              ...
              {/*
                We pass our "add to cart" callback to <VariantSelector>.
                That component will show the "Add to Cart" button.
              */}
              <VariantSelector
                variants={variants}
