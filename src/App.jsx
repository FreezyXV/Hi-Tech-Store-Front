...
// Import the Loader component for Suspense fallback
...
// Fallback loader to display while lazy-loaded chunks are retrieved
const FallbackLoader = () => <Loader />;

// Simple ErrorBoundary that uses Suspense for lazy loading
const ErrorBoundary = ({ children }) => {
  return (
